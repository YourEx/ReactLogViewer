...
var LogViewer = React.createClass({
  ...
  getInitialState: function() {    
    return logViewerStore.getState();
  },

  render: function(){
    var indicator;
    var saveEditButtons;    
    var logs = this.state.searchValue ? 
      logViewerStore.getFilteredLogs() : this.state.logs;
   ...
   _onChange: function(){    
      this.setState(logViewerStore.getState());
  }
